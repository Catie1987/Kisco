...
const Filterbutton = document.querySelectorAll(".container button");
const Filternews = document.querySelectorAll(".news-wrapper .news-box");
...
Filterbutton.forEach(button => button.addEventListener("click", filternew));